...
int main(){
    ...
    unsigned int seed = 374; // sampled at random from RANDOM.ORG
    ...
    // rounds
    unsigned int blocks_per_round  = 130;
    ...
    FlatTopology internetTopology{V,d,2000.,500.};
