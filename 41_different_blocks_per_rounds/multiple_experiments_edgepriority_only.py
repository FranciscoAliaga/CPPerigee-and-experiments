...
ax.set_title("Curva $\lambda^{90\%}$ para protocolo Edge Priority")
...
for n,d in enumerate(dirs):
    ...
    ax2.plot(bb,ww,label=label,marker="*")

#
ax2.set_title("Métrica de latencia global v/s número de bloques \n para el protocolo EdgePriority con rondas de distinta duración")
