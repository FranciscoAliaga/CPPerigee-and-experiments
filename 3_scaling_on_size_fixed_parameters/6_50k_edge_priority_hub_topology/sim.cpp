...
int main(){
    ...
    HubTopology internetTopology{V,d,1.,0.}; // hubTopology
    ...
    Network N(nodes,internetTopology,blockSize,dout,din,threads,332241);

    //////////////////////////////////////////////////////////////////////////////////////////////////// SIMULATION
    metrics::parameters pars {};
    pars.percentiles = {90.};
    pars.randomized = true;
    pars.randomSamples = static_cast<unsigned int>(50000 * 0.02);
    ...
    for(unsigned int i = 1; i <= 10; i++){
        ...
        std::string filename = "after_" + std::to_string(i*1000) + "_blocks";
        N.writeMetricsCSV(filename,metrics::kind::TimeToHashPowerPercent,pars);
    }
